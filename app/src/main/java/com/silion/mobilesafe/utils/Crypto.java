...
public class Crypto {
    ...
    public static String encrypt(String seed, String plain) throws Exception {
        ...
        byte[] encrypted = encrypt(rawKey, plain.getBytes("UTF-8"));
    ...
    public static String decrypt(String seed, String encrypted)
            throws Exception {
        byte[] rawKey = getRawKey(seed.getBytes());
        byte[] enc = Base64.decode(encrypted.getBytes("UTF-8"), Base64.DEFAULT);
...
//        SecureRandom random = SecureRandom.getInstance("SHA1PRNG"); javax.crypto.BadPaddingException: pad block corrupted
